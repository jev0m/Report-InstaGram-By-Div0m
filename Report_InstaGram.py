...
id = "-".join(x)
print('Your ID : '+id)
req = requests.get('https://pastebin.com/srYZ914L').text
if x in req:
    pass
else:
    print("Your Not Member")
    print("If you want buy the tool text me Telgrame : Div0mbot")
    exit()



os.system('xdg-open https://shoplinks.to/jev0mstore')
os.system('clear')
